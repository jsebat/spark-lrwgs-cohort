...
# 05_denovo/miss_tier.py counts the four dbNSFP rankscore thresholds of the lab's v2 forward selection. It is driven
...
log("wrote %s -- input for 05_denovo/miss_tier.py (set DENOVO_TSV to it, MISS_OUT to where the tiers land)" % mt)
