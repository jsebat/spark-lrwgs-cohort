...
annotation columns of the feature table. Sources, verbatim:
  ...
  SNV/indel H3  H2 and PON leave-one-out AC < 3 and not shared by both siblings  (03_panel/apply_pon_loo.sb, 05_denovo)
  ...
  TR H2         02_tiering/tr_outliers.py: SD >= 5 on every allele of all three, child allele > max(parents) + max(6 bp,
