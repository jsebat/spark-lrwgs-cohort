...
Generalises 14_x_inactivation/03_trio_phase_x.py (father hemizygous on X) and the four-case rule in
12_methylation/pofo_local.py to any site: with the child heterozygous a|b, the assignment
...
# GRCh38 pseudoautosomal regions (same values as 14_x_inactivation/03_trio_phase_x.py)
