# Frozen classifiers (P21) — release 2026-09-14
...
cross-validation over five outer-fold seeds (DESIGN P12–P14, P23–P24). Training run `harness_v2`, 2026-09-13/14, on the
...
|---|---|---|---|---|---|
| SNV/indel | `snv_indel.xgb.json` | `08537e17e3ebe21c` | 55 | 1,740,060 | 1,041,175 |
| SV | `sv.xgb.json` | `178b1f12c1de40fe` | 38 | 442,963 | 420,529 |
| TR | `tr.xgb.json` | `92244644ef26c8cd` | 41 | 1,206,502 | 519,346 |
...
|---|---|---|---|
| SNV/indel | 0.99 | 0.95 | 73 (64 SNV + 7 indel), paternal fraction 0.77; exonic WES precision 1.00, recall 0.73 |
| SV | 0.99 | 0.97 | 0.3 (10 cohort-wide) |
| TR | 0.999 | 0.997 | 15, paternal fraction 0.70 |
