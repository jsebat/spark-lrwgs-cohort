...
# GRCh38 pseudoautosomal regions, for haploid_flag. Same values as 14_x_inactivation/03_trio_phase_x.py
# and as ../../02_phasing/src/trio_phase/phasing/orient.py, which is where this used to be imported
