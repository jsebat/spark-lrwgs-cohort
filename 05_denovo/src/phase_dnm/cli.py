...
# The phasing stage (orient / transmission / xo-reads / hapdepth / phase-qc, formerly M1) is its own
# module: ../02_phasing, package `trio_phase`, CLI `trio-phase`. This module CONSUMES its tables by
# path under $PHASE_DIR (see config/phase_dnm.env and the --orientation / --transmission /
# --changepoints flags of the M2 commands) and deliberately does not import it.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    an.add_argument("--tr-min-spanning", type=int, default=5, help="TR: minimum spanning-read depth (SD) for a founder allele to enter the reference (03_tiering/tr_outliers.py uses 5)")
